...
/**
 * * This class is what we will test your code on. If your BestPath * objects
 * equal ours (using the .equals method given) then you will * pass the tests.
 * Do no modify anything that is given (use it of * course but don't change names
 * etc.) * * @author CS2420 Teaching Staff - Spring 2016
 */
